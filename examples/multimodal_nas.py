...
class BayesOptimFactory:
    def __init__(self):
        self.base_graph = nx.DiGraph()
        starts = [1, 2]
        ends = [9,]
        self.base_graph.add_edge(1, 3)
        self.base_graph.add_edge(2, 4)
        self.base_graph.add_edge(3, 5)
        self.base_graph.add_edge(3, 6)
        self.base_graph.add_edge(4, 5)
        self.base_graph.add_edge(4, 7)
        self.base_graph.add_edge(5, 6)
        self.base_graph.add_edge(5, 7)
        self.base_graph.add_edge(5, 8)
        self.base_graph.add_edge(6, 8)
        self.base_graph.add_edge(7, 8)
        self.base_graph.add_edge(8, 9)
    ...
    def create_graph(self, starts, ends, max_samples=100):
        
        pass

    def bayes_optims(self):
        pass
